...
void D3DClass::TurnOnAlphaBlending()
{
	...
	//m_deviceContext->OMSetBlendState(m_alphaEnableBlendingState, blendFactor, 0x00000000);
...
void D3DClass::TurnOffAlphaBlending()
{
	...
	//m_deviceContext->OMSetBlendState(m_alphaDisableBlendingState, blendFactor, 0x00000000);
